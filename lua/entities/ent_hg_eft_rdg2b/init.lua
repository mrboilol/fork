...
function ENT:PhysicsCollide(data, phys)
	...
	if data.Speed > 100 then
        self:EmitSound("weapons/darsu_eft/grenades/grenade_collision_smoke_russian1.ogg", 75, math.random(95, 110), 1)
	end
end
...
function ENT:DoParticle()
	...
	if self.Burn == 120 then self:StopLoopingSound(self.snd or 0) end
...
function ENT:Explode()
	...
	--self:DoParticle()
	timer.Create("smokenade" .. self:EntIndex(), 1, 120, function()
