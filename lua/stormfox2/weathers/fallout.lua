...
if CLIENT then
	...
	local rain_watersurf = StormFox2.Ambience.CreateAmbienceSnd( "ambient/water/water_run1.ogg", SF_AMB_UNDER_WATER_Z, 0.1 )
	...
	function rad.Think()
		...
		if nt < CurTime() then
			...
			for i,v in ipairs( player.GetAll() ) do
				...
				v:EmitSound("player/geiger" .. math.random(1,3) .. ".ogg")
			end
		end
	end
end
