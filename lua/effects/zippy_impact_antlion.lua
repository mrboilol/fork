...
function EFFECT:Init(data)
    ...
    for i = 1,10*intensity do
        local splinter = emitter:Add("effects/fleck_antlion" .. math.random(1, 2), pos+normal*8)
        ...
        splinter:SetVelocity((normal*math.Rand(40, 200)+VectorRand()*50)*intensity*0.75)
    end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
