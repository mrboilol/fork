...
HG_SEAL_CONFIG = HG_SEAL_CONFIG or {
    ...
    ANGER_TARGET_RANGE = 325,
    ANGER_DANGER_TARGET_RANGE = 400,
    BITE_RANGE = 82,
    BITE_DAMAGE = 14,
    BITE_COOLDOWN_MIN = 2.4,
    BITE_COOLDOWN_MAX = 3.8,
    ANGRY_ATTACK_WINDUP = 0.65,
    ANGRY_LEAP_RANGE = 240,
    ANGRY_LEAP_INTERVAL_MIN = 0.75,
    ANGRY_LEAP_INTERVAL_MAX = 1.15,
    ANGRY_LEAP_FORCE = 575,
    ANGRY_LEAP_UPWARD_FORCE = 800,
