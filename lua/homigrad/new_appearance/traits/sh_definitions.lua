...
Register("vibrams", {Name = "vibram ones", Description = "Your excellent outsole provides superior traction, balance, and footing.", Category = "positive", Points = 3, SortOrder = 100, Modifiers = {slip_chance = 0.03, terrain_trip_chance = 0.1, collision_trip_chance = 0.1, climb_stamina_cost = 0.45, climb_force = 1.45, movement_debuff_resistance = 0.35}})
...
Register("blind", {Name = "Blind", Description = "You cant see, but you got used to it. Distant sounds reveal the world around them.", Category = "negative", Points = 6, SortOrder = 20})
...
Register("clumsy", {Name = "Clumsy", Description = "You tend to mess up sometimes doing tasks.", Category = "negative", Points = 3, SortOrder = 70, Modifiers = {weapon_handling = 1.8, weapon_weight = 0.72}})
...
Register("nyctophobia", {Name = "Nyctophobia", Description = "You are really, really afraid of the dark.", Category = "negative", Points = 4, SortOrder = 157})
