...
Register("sprinter", {Name = "Sprinter", Description = "You move much faster and get less tired from it.", Category = "positive", Points = 3, SortOrder = 30, Modifiers = {sprint_stamina_cost = 0.45, movement_speed = 1.28, headbob = 1.4}})
...
Register("paraplegic", {Name = "Paraplegic", Description = "You cant move your legs.", Category = "negative", Points = 5, SortOrder = 10})
...
Register("clumsy", {Name = "Clumsy", Description = "just a silly gubby", Category = "negative", Points = 4, SortOrder = 70, Modifiers = {weapon_handling = 1.45}})
...
if CLIENT then
	...
	hook.Add("RenderScreenspaceEffects", "HGTraitsJohnVision", function()
		local ply = LocalPlayer()
		if IsValid(ply) and ply:Alive() and ply:HasTrait("john") then DrawMotionBlur(0.05, 0.08, 0.01) end
	end)
end
