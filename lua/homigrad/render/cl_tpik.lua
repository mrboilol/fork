...
function hg.DoTPIK(ply, ent)
    ...
    ply.lerp_lh = leftArmAmputated and 0 or math.Approach(ply.lerp_lh or 0, lhik2 and 1 or 0, FrameTime() * 2.0 * game.GetTimeScale())//LerpFT(0.1, ply.lerp_lh or 1, lhik2 and 1 or 0)
