...
module[2] = function(owner, org, timeValue)
	...
	local traitStaminaMax = owner.GetTraitMultiplier and owner:GetTraitMultiplier("stamina_max", 1) or 1
	stamina.max = ((org.superfighter and 2 or 1) * ((stamina.range * (1 - (org.pneumothorax) / 2) + org.adrenaline * 20 ) * math.max(1 - org.hemotransfusionshock,0.2)) * math.max(1 - (org.hungry/100),0.65) * math.Clamp(0.55 + perfusionMoveMul * 0.45, 0.55, 1) * hypotensionStaminaMul) * heatStaminaMul * traitStaminaMax
