...
local thoughtMessages = {
    ...
    blood_4000 = "Your body feels weak from blood loss. ",
    blood_3500 = "Your organs feel heavy from blood loss.",
    blood_3000 = "Blood loss is starting to affect your health.",
