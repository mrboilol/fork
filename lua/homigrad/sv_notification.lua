...
local thoughtMessages = {
    ...
    blood_4500 = "You are starting to feel faint.",
    blood_4000 = "Your body feels weak and hard to move.",
    blood_3500 = "Everything feels heavy.",
    blood_3000 = "Your vision is starting to fade.",
    ...
    arrhythmia = "Your heartbeat is irregular.",
    tachycardia = "Your heart is beating dangerously fast.",
    bradycardia = "Your heart is beating dangerously slowly.",
    temperature_cold = "You are getting cold.",
    temperature_hot = "You are getting hot.",
    hungry = "You are hungry.",
    temperature_very_cold = "You are very cold.",
    temperature_very_hot = "You are very hot.",
