...
SWEP.AnimsEvents = {
	...
	["reload0"] = {
		...
		[0.5] = function(self) self:EmitSound("weapons/darsu_eft/val/val_magin.mp3") end,
	},
	["reload_empty0_0"] = {
		[0.10] = function(self) self:EmitSound("weapons/darsu_eft/val/val_magout.mp3") end,
		[0.23] = function(self) self:EmitSound("arc9_eft_shared/generic_mag_pouch_out3.mp3") end,
		[0.35] = function(self) self:EmitSound("weapons/darsu_eft/val/val_magin.mp3") end,
		[0.65] = function(self) self:EmitSound("weapons/darsu_eft/val/val_boltout.mp3") end,
		[0.75] = function(self) self:EmitSound("weapons/darsu_eft/val/val_boltin.mp3") end,
	},
}
...
SWEP.DistSound = "weapons/darsu_eft/val/val_dist.ogg"
