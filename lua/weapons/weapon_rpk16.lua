...
SWEP.HeldMagModel = "models/weapons/mods/mag_ak_izhmash_rpk16_drum_545x39_95.mdl"
SWEP.HeldMagBone = "mod_magazine"
SWEP.HeldMagOffsetPos = Vector(0, 0, 0)
SWEP.HeldMagOffsetAng = Angle(0, 0, 0)

SWEP.HeldHandguardModel = "models/weapons/mods/rpk16_hg.mdl"
