...
SWEP.MagModel = "models/weapons/mods/mag_aps_20.mdl"
...
SWEP.LocalMuzzlePos = Vector(3, -2.75, 1.6)
...
SWEP.AnimsEvents = {
    ...
    ["reload"] = {
        [0.2] = function(self)
            self:EmitSound("weapons/darsu_eft/aps/aps_mag_out.mp3")
            self:EmitSound("arc9_eft_shared/generic_mag_pouch_in1.mp3")
        end,
        [0.4] = function(self) self:EmitSound("arc9_eft_shared/generic_mag_pouch_out1.mp3") end,
        [0.7] = function(self) self:EmitSound("weapons/darsu_eft/aps/aps_mag_in.mp3") end,
    },
    ["reload_empty"] = {
        [0.025] = function(self) self:EmitSound("weapons/darsu_eft/aps/aps_slider_out.mp3") end,
		[0.2] = function(self) self:EmitSound("weapons/darsu_eft/aps/aps_mag_out.mp3") end,
		[0.23] = function(self) self:EmitSound("arc9_eft_shared/generic_mag_pouch_out1.mp3") end,
		[0.56] = function(self) self:EmitSound("weapons/darsu_eft/aps/aps_mag_in.mp3") end,
		[0.7] = function(self) self:EmitSound("weapons/darsu_eft/aps/aps_slider_in.mp3") end,
    },
}
