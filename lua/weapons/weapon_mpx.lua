...
SWEP.CustomizeCategory = "SIG MPX"
...
SWEP.HeldMagModel = "models/weapons/mods/mag_mpx_30.mdl"
SWEP.HeldMagBone = "mod_magazine"
SWEP.HeldMagOffsetPos = Vector(0, 0, 0)
SWEP.HeldMagOffsetAng = Angle(0, -90, 0)

SWEP.HeldHandguardModel = "models/weapons/mods/handguard_mpx_sig_mpx_gen1_8_inch.mdl"
SWEP.HeldHandguardBone = "weapon"
SWEP.HeldHandguardOffsetPos = Vector(0, -16.76, -0.968)
SWEP.HeldHandguardOffsetAng = Angle(0, -90, 0)

SWEP.HeldPistolgripModel = "models/weapons/mods/pistolgrip_mpx.mdl"
SWEP.HeldPistolgripBone = "weapon"
SWEP.HeldPistolgripOffsetPos = Vector(0, -11, -2)
SWEP.HeldPistolgripOffsetAng = Angle(0, -90, 0)

SWEP.HeldStockModel = "models/weapons/mods/stock_all_sig_mpx_brace.mdl"
