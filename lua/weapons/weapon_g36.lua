...
SWEP.AnimsEvents = {
	...
	["reload0"] = {
		[0.10] = function(self) self:EmitSound("weapons/darsu_eft/g36/g36_mag_out.mp3") end,
	...
	["reload_empty0_0"] = {
		...
		[0.45] = function(self) self:EmitSound("weapons/darsu_eft/g36/g36_mag_in.mp3") end,
		[0.65] = function(self) self:EmitSound("weapons/darsu_eft/g36/g36_bolt_out_check.mp3") end,
		[0.75] = function(self) self:EmitSound("weapons/darsu_eft/g36/g36_bolt_in.mp3") end,
	},
}
