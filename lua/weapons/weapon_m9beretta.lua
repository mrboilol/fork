...
SWEP.AnimsEvents = {
    ...
    ["reload_empty"] = {
		...
		[0.82] = function(self) self:EmitSound("zcitysnd/sound/weapons/m9/handling/m9_boltrelease.ogg") end,
    },
}
...
SWEP.MagModel = "models/weapons/mods/mag_glock_bigstick_24.mdl"
SWEP.ReloadTime = 3
