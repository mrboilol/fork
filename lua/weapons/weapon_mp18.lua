...
SWEP.Primary.Sound = {"weapons/darsu_eft/mp18/mr18_fire_close.mp3", 85, 100, 100}
SWEP.SupressedSound = {"weapons/darsu_eft/mp18/mr18_fire_indoor_close.mp3", 65, 100, 100} -- Или заменить на сайленс, если есть
...
SWEP.AnimsSounds = {
    ["draw"] = {
        [0.05] = function(self) self:EmitSound("arc9_eft_shared/weap_in.mp3") end,
    },
    ["holster"] = {
        [0.05] = function(self) self:EmitSound("arc9_eft_shared/weap_out.mp3") end,
    },
    ["fire"] = {
