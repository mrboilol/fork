...
SWEP.weaponPos = Vector(3.6,-1.3,4)
SWEP.weaponAng = Angle(180,170,0)
...
SWEP.swingsoundextra = {
    {"weapons/darsu_eft/melee/scythe_whoosh_04.mp3", 90, {95, 105}},
}
...
if CLIENT then
	SWEP.WepSelectIcon = Material("entities/arc9_eft_melee_rebel.png")
	SWEP.IconOverride = "entities/arc9_eft_melee_rebel.png"
