...
SWEP.AnimsEvents = {
	...
	["reload_empty"] = {
		...
		[0.5] = function(self) self:EmitSound("weapons/darsu_eft/ak/akm_magin_metal.mp3") end,
		[0.65] = function(self) self:EmitSound("weapons/darsu_eft/m4a1/mcx_bolt_out.mp3") end,
		[0.75] = function(self) self:EmitSound("weapons/darsu_eft/m4a1/mcx_bolt_in.mp3") end,
	},
}
