...
SWEP.AnimsEvents = {
	...
	["reload556"] = {
		...
		[0.55] = function(self) self:EmitSound("weapons/darsu_eft/ak/akm_magin_metal.mp3") end,
	},
	["reload556_empty"] = {
		...
		[0.25] = function(self) self:EmitSound("arc9_eft_shared/generic_mag_pouch_out3.mp3") end,
		...
		[0.82] = function(self) self:EmitSound("weapons/darsu_eft/ak/akms_slider_down.mp3") end,
	},
}
