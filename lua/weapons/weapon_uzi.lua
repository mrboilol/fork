...
SWEP.AnimsEvents = {
	...
	["reload"] = {
		[0.10] = function(self) self:EmitSound("weapons/darsu_eft/uzi/uzip_mag_out.mp3") end,
		...
		[0.65] = function(self) self:EmitSound("weapons/darsu_eft/uzi/uzip_mag_in.mp3") end,
	},
	["reload_empty"] = {
		[0.10] = function(self) self:EmitSound("weapons/darsu_eft/uzi/mp7_mag_button.mp3") end,
		[0.15] = function(self) self:EmitSound("weapons/darsu_eft/uzi/uzip_mag_out.mp3") end,
		[0.23] = function(self) self:EmitSound("arc9_eft_shared/generic_mag_pouch_out3.mp3") end,
		[0.45] = function(self) self:EmitSound("weapons/darsu_eft/uzi/uzip_mag_in.mp3") end,
		[0.65] = function(self) self:EmitSound("weapons/darsu_eft/uzi/uzip_bolt_in.mp3") end,
		[0.75] = function(self) self:EmitSound("weapons/darsu_eft/uzi/uzip_bolt_out.mp3") end,
	},
}
...
SWEP.animposmul = 2
SWEP.Primary.Sound = {"weapons/darsu_eft/uzipro/fire_new/uzi_outdoor_close_loop1.ogg", 85, 120, 130}
