...
SWEP.PrintName = "Zarya"
SWEP.Instructions =
[[Zarya is a non-lethal flashbang grenade.
Disorients and blinds targets in the detonation area.
Most effective for room entries and close-quarters pushes.
...
SWEP.WorldModel = "models/weapons/EFTNades/darsu_eft/w_zarya_unthrowed.mdl"
SWEP.WorldModelReal = "models/weapons/EFTNades/darsu_eft/c_zarya_2.mdl"
SWEP.WorldModelExchange = false

SWEP.ENT = "ent_hg_eft_zarya"

if CLIENT then
	SWEP.WepSelectIcon = Material("entities/weapon_hg_eft_zarya.png")
	SWEP.IconOverride = "entities/weapon_hg_eft_zarya.png"
