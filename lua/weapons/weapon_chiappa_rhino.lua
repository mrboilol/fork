...
SWEP.AnimsEvents = {
    ...
    ["reload"] = {
        [0.025] = function(self) self:EmitSound("weapons/darsu_eft/rhino/rhino_drum_out.mp3") end,
		[0.2] = function(self)
			self:EmitSound("weapons/darsu_eft/rhino/rhino_drum_purge_all.mp3")
		...
		[0.56] = function(self) self:EmitSound("weapons/darsu_eft/rhino/rhino_drum_extractor.mp3") end,
		[0.7] = function(self) self:EmitSound("weapons/darsu_eft/rhino/rhino_drum_in.mp3") end,
    },
    ["reload_empty"] = {
        [0.025] = function(self) self:EmitSound("weapons/darsu_eft/rhino/rhino_drum_out.mp3") end,
		[0.2] = function(self) self:EmitSound("weapons/darsu_eft/rhino/rhino_drum_purge_all.mp3") end,
