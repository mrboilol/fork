...
SWEP.PrintName = "RGN"
SWEP.Instructions =
[[RGN is a modern fragmentation grenade.
Balanced blast and fragment effect for general combat use.
Works well in urban fights and short engagements.
...
SWEP.WorldModel = "models/weapons/EFTNades/darsu_eft/w_rgn_unthrowed.mdl"
SWEP.WorldModelReal = "models/weapons/EFTNades/darsu_eft/c_rgn_rgo_2.mdl"
SWEP.WorldModelExchange = false

SWEP.ENT = "ent_hg_eft_rgn"

if CLIENT then
	SWEP.WepSelectIcon = Material("entities/weapon_hg_eft_rgn.png")
	SWEP.IconOverride = "entities/weapon_hg_eft_rgn.png"
