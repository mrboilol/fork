...
SWEP.ARC9Parts = {
	...
	stock = {
		model = "models/weapons/mods/ak_stock_evo.mdl",
		bonemerge = false,
		bone = "weapon",
...
SWEP.availableAttachments = {
	...
	sight = {
		...
		["mount"] = {["dovetail"] = Vector(-24, -0.25, 1.25), ["picatinny"] = Vector(-22, 0, 1.9)},
		["mountAngle"] = Angle(0,0,90)
	},
		grip = {
		["mount"] = {["picatinny"] = Vector(7, 1.3, -1)},
		["mountType"] = {"picatinny"},
		["mountAngle"] = Angle(0,0,90)
	},
}
