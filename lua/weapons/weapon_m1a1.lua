...
SWEP.Author = "private pylon"
SWEP.Instructions = "7.62 MILLIMETER. FULL. METAL. JACKET."
...
SWEP.Primary.Sound = {"weapons/darsu_eft/sa58/fal_outdoor_close_loop1.ogg", 85, 90, 100}
SWEP.SupressedSound = {"weapons/darsu_eft/sa58/fal_silenced_loop1.ogg", 65, 90, 100}
