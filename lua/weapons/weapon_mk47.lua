...
SWEP.CustomizeCategory = "CMMG Mk47"
...
SWEP.HeldMagModel = "models/weapons/mods/mag_ak_ultimag.mdl"
SWEP.HeldMagBone = "mod_magazine"
SWEP.HeldMagOffsetPos = Vector(0, 0, 0)
SWEP.HeldMagOffsetAng = Angle(0, 0, 0)

SWEP.HeldStockModel = "models/weapons/mods/stock_ar15_cmmg_mil_spec_tube.mdl"
SWEP.HeldStockBone = "weapon"
SWEP.HeldStockOffsetPos = Vector(0, -8.8, 0.05)
SWEP.HeldStockOffsetAng = Angle(0, -90, 0)

SWEP.HeldStock1Model = "models/weapons/mods/stock_ar15_fab_defense_gl_core_s.mdl"
SWEP.HeldStock1Bone = "weapon"
SWEP.HeldStock1OffsetPos = Vector(0, -6.75, -0.85)
SWEP.HeldStock1OffsetAng = Angle(0, -90, 0)

SWEP.HeldPistolgripModel = "models/weapons/mods/pistolgrip_ar15_hk_battle_grip.mdl"
SWEP.HeldPistolgripBone = "weapon"
SWEP.HeldPistolgripOffsetPos = Vector(0, -11.25, -2)
SWEP.HeldPistolgripOffsetAng = Angle(0, -90, 0)

SWEP.HeldHandguardModel = "models/weapons/mods/handguard_ar10_cmmg_mk3_rml15.mdl"
SWEP.HeldHandguardBone = "weapon"
SWEP.HeldHandguardOffsetPos = Vector(0, -17.3, 0.15)
