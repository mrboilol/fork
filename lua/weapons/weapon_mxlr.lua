...
SWEP.AnimsEvents = {
    ["ready"] = {
        ...
        [0.41] = function(self) self:EmitSound(path .. "marlin_bolt_out_empt.mp3") end,
        [0.64] = function(self) self:EmitSound(path .. "marlin_bolt_in.mp3") end,
    },
    ["draw"] = {
        [0] = function(self) self:EmitSound("weapons/darsu_eft/mosin/mr133_draw.mp3") end,
    },
    ...
    ["fire"] = {
        [0] = function(self) self:EmitSound(path .. "marlin_hammer_in.mp3") end,
    },
    ["dryfire"] = {
        [0] = function(self) self:EmitSound(path .. "marlin_hammer_in.mp3") end,
    },
    ["dryfire_empty"] = {
        [0] = function(self) self:EmitSound(path .. "marlin_hammer_out.mp3") end,
    },
    ["cycle"] = {
        [0] = function(self) self:EmitSound(path .. "marlin_bolt_out_shell.mp3") end,
        [0.15] = function(self) self:EmitSound(randspin[math.random(#randspin)]) end,
        [0.2] = function(self) self:EmitSound(path .. "marlin_bolt_in.mp3") end,
    },
    ["reload_single"] = {
        [0] = function(self) self:EmitSound(path .. "marlin_bolt_out_shell.mp3") end,
        ...
        [1.05] = function(self) self:EmitSound(path .. "marlin_round_in_chamber.mp3") end,
        [1.56] = function(self) self:EmitSound(path .. "marlin_bolt_in.mp3") end,
    ...
    ["sgreload_start_empty"] = {
        ...
        [0.55] = function(self) self:EmitSound("weapons/darsu_eft/mosin/ammo_singleround_pickup.mp3") end,
        [1.05] = function(self) self:EmitSound(path .. "marlin_round_in_chamber.mp3") end,
        [1.74] = function(self) self:EmitSound(path .. "marlin_bolt_in.mp3") end,
    ...
    ["sgreload_insert"] = {
        ...
        [0.32] = function(self) 
            local sounds = { path .. "marlin_round_in_1.mp3", path .. "marlin_round_in_2.mp3", path .. "marlin_round_in_3.mp3", path .. "marlin_round_in_4.mp3", path .. "marlin_round_in_5.mp3" }
    ...
    ["check"] = {
        ...
        [0.3] = function(self) self:EmitSound(path .. "marlin_mag_check.mp3") end,
    ...
    ["check_chamber"] = {
        [0] = function(self) self:EmitSound(randspin[math.random(#randspin)]) end,
        [0.15] = function(self) self:EmitSound(path .. "marlin_bolt_out_check.mp3") end,
        [0.7] = function(self) self:EmitSound(path .. "marlin_bolt_in_check.mp3") end,
    ...
    ["jam_shell"] = {
        [0] = function(self) self:EmitSound(path .. "marlin_bolt_out_shell.mp3") end,
        [0.15] = function(self) self:EmitSound(randspin[math.random(#randspin)]) end,
        [0.25] = function(self) self:EmitSound(path .. "marlin_bolt_in.mp3") end,
        [0.33] = function(self) self:EmitSound(path .. "marlin_bolt_in_fail_1.mp3") end,
        [0.6] = function(self) self:EmitSound(path .. "marlin_gunflip_look_1.mp3") end,
        [1.37] = function(self) self:EmitSound(path .. "marlin_shell_extract.mp3") end,
        [1.96] = function(self) self:EmitSound(path .. "marlin_gunflip_2.mp3") end,
        [2.4] = function(self) self:EmitSound(path .. "marlin_gunflip_3.mp3") end,
        [3.1] = function(self) self:EmitSound(path .. "marlin_gunflip_1.mp3") end,
        [3.58] = function(self) self:EmitSound(randspin[math.random(#randspin)]) end,
    },
    ["jam_feed"] = {
        [0] = function(self) self:EmitSound(path .. "marlin_bolt_out_shell.mp3") end,
        [0.15] = function(self) self:EmitSound(randspin[math.random(#randspin)]) end,
        [0.25] = function(self) self:EmitSound(path .. "marlin_bolt_in_fail_1.mp3") end,
        [0.7] = function(self) self:EmitSound(randspin[math.random(#randspin)]) end,
        [1.25] = function(self) self:EmitSound(randspin[math.random(#randspin)]) end,
        [2.05] = function(self) self:EmitSound(path .. "marlin_bolt_in_fail_1.mp3") end,
        [2.55] = function(self) self:EmitSound(path .. "marlin_bolt_in_fail_2.mp3") end,
        [3.1] = function(self) self:EmitSound(path .. "marlin_feed_flip_1.mp3") end,
        [3.7] = function(self) self:EmitSound(path .. "marlin_feed_flip_2.mp3") end,
        [3.81] = function(self) self:EmitSound(path .. "generic_jam_shell_ remove_medium3.mp3") end,
        [4.35] = function(self) self:EmitSound(path .. "marlin_bolt_in.mp3") end,
        [4.45] = function(self) self:EmitSound(randspin[math.random(#randspin)]) end,
        [4.7] = function(self) self:EmitSound(path .. "marlin_gunflip_look_1.mp3") end,
        [5.1] = function(self) self:EmitSound(path .. "marlin_bolt_out_shell.mp3") end,
        [5.3] = function(self) self:EmitSound(path .. "marlin_bolt_in.mp3") end,
        [5.57] = function(self) self:EmitSound(randspin[math.random(#randspin)]) end,
    },
    ["jam_hard"] = {
        [0] = function(self) self:EmitSound(path .. "marlin_bolt_out_fail_1.mp3") end,
        [0.15] = function(self) self:EmitSound(randspin[math.random(#randspin)]) end,
        [0.55] = function(self) self:EmitSound(path .. "marlin_bolt_out_fail_2.mp3") end,
        ...
        [2.26] = function(self) self:EmitSound(path .. "marlin_bolt_out_fail_1.mp3") end,
        [2.66] = function(self) self:EmitSound(path .. "marlin_bolt_out_check.mp3") end,
        [3] = function(self) self:EmitSound(randspin[math.random(#randspin)]) end,
        [3.44] = function(self) self:EmitSound(path .. "marlin_bolt_out_shell.mp3") end,
        [3.64] = function(self) self:EmitSound(path .. "marlin_bolt_in.mp3") end,
    ...
    ["jam_soft"] = {
        ...
        [0.84] = function(self) self:EmitSound(randspin[math.random(#randspin)]) end,
        [1.4] = function(self) self:EmitSound(randspin[math.random(#randspin)]) end,
        [1.85] = function(self) self:EmitSound(path .. "marlin_bolt_out_check.mp3") end,
        [2.35] = function(self) self:EmitSound(path .. "marlin_bolt_out_shell.mp3") end,
        [2.57] = function(self) self:EmitSound(path .. "marlin_bolt_in.mp3") end,
    },
}
