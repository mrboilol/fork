...
SWEP.WorldModel = "models/weapons/w_melee_labris.mdl"
SWEP.WorldModelReal = "models/weapons/ravaged/anim_axe_fire.mdl"
SWEP.WorldModelExchange = "models/weapons/w_melee_labris.mdl"
SWEP.ViewModel = ""
SWEP.modelscale = 1.2
