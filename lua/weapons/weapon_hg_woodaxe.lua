...
SWEP.WorldModel = "models/weapons/w_melee_util_axe.mdl"
SWEP.WorldModelReal = "models/weapons/tfa_nmrih/v_me_hatchet.mdl"
SWEP.WorldModelExchange = "models/weapons/w_melee_util_axe.mdl"
...
function SWEP:CustomAttack2()
    ...
    ent.modelscale = self.modelscale or 1
