...
SWEP.AnimsEvents = {
    ...
    ["reload"] = {
        [0.10] = function(self) self:EmitSound("weapons/darsu_eft/mp9/fiveseven_mag_out.mp3") end,
		...
		[0.45] = function(self) self:EmitSound("weapons/darsu_eft/mp9/fiveseven_mag_in.mp3") end,

    },
    ["reload_empty"] = {
        [0.10] = function(self) self:EmitSound("weapons/darsu_eft/mp7/mp7_mag_button.mp3") end,
        [0.15] = function(self) self:EmitSound("weapons/darsu_eft/mp9/fiveseven_mag_out.mp3") end,
