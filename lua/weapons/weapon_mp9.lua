...
SWEP.Instructions = "The B&T MP9 is a compact Swiss submachine gun, developed from the Steyr TMP. Known for its polymer construction, folding stock and high rate of fire, it is designed as a lightweight, personal defense weapon for special forces and police units."
...
//SWEP.FakeScale = 1.2
SWEP.FakePos = Vector(-8.5, 0.73, 5.57)
SWEP.FakeAng = Angle(0, 0, 0)
SWEP.AttachmentPos = Vector(1.5,-1.65,0.24)
...
SWEP.FakeReloadSounds = {
	...
	[0.35] = "weapons/bt_mp9/mp9_magout.wav",              -- Вытаскиваем магазин
	[0.65] = "weapons/universal/uni_crawl_l_02.wav",      -- Шуршание
	[0.78] = "weapons/bt_mp9/mp9_magin.wav",               -- Вставляем магазин
...
SWEP.FakeEmptyReloadSounds = {
	...
	[0.22] = "weapons/bt_mp9/mp5k_magrelease.wav",        -- Щелчок сброса (из твоей папки)
	[0.30] = "weapons/bt_mp9/mp9_magout.wav",              -- Выпадение магазина
	[0.60] = "weapons/bt_mp9/mp9_magin.wav",               -- Вставка нового
	
	-- Снятие с затворной задержки (кнопка)
	-- Если хочешь звук передергивания ручки, замени на "mp9_boltback.wav"
	[0.85] = "weapons/bt_mp9/mp9_boltrelease.wav",         
}
...
SWEP.animposmul = 2
SWEP.Primary.Sound = {"weapons/bt_mp9/mp9_fire.wav", 75, 120, 130}
SWEP.SupressedSound = {"weapons/bt_mp9/mp9_fire_suppressed.wav", 55, 90, 100}
SWEP.Primary.Wait = 0.05

SWEP.WepSelectIcon2 = Material("entities/arc9_eft_mp91.png")

SWEP.availableAttachments = {
	barrel = {
		[1] = {"supressor4", Vector(0,0,0), {}},
		[2] = {"", Vector(0,0,0), {}},
		["mount"] = Vector(-2,2.1,-0.2),
	},
	sight = {
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(-3, -1.92, 3.9)
